...
import { addCustomToken, removeAllCustomToken } from "../../../reducers/customTokenReducer";


const ManageCustomToken = ({ ethCustomTokens, addCustomToken, removeAllCustomToken }) => {
    ...
    return (
        <div>
                    ...
                    <Row align="middle">
                        ...
                        <Col span={12}>
                            <Row justify="end" align="middle">
                                <Button shape="round" onClick={() => { importTokenHandler('eth') }}>Import</Button>
                            </Row>
                        </Col>
                    </Row>
                </div>
            ...
            <div style={{ height: '30vh' }}>
                ...
                {
                    getCustomTokens('eth').length ?
                        getCustomTokens('eth').map((i) => <ManageCustomTokenItem name={i.name} symbol={i.symbol} icon={i.logo} chain={'eth'} address={i.address} onClickDelete={onClickChildDeleteHandler} />)
                        :
