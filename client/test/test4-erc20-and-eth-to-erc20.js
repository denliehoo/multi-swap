  ...
  (accounts) => {
    ...
    describe('Swap ETH for multiple', async () => {
      ...
      it('Tokens should approve', async () => {
        ...
        for (let i in poolAddressesInInitial) {
          const allowance = await instance.allowanceERC20(poolAddressesInInitial[i])
    ...
    describe('Check For Swap Multiple Tokens And Eth For Multiple Tokens', async () => {
      it('Get amounts out', async () => {
        ...
        const getAmountsOut = await instance.getAmountsOutTokensAndEthForMultipleTokensByPercent(
          poolAddressesIn,
          amountForEachTokensIn,
          poolAddressesOut,
      ...
      it('Swap Should Work', async () => {
        const receipt2 = await instance.swapTokensAndEthForMultipleTokensByPercent(
          poolAddressesIn,
          amountForEachTokensIn,
          poolAddressesOut,
          percentForEachTokenOut,
